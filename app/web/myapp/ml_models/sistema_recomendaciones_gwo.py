...
'TIPO_SIEMBRA': np.random.choice(["Manual","Mecanizado"]),
'SEM_TRATADAS':np.random.choice(SEM_TRATADAS),
'MATERIAL_GENETICO':np.random.choice(MATERIAL_GENETICO),
'DRENAJE':np.random.randint(0,1),
'METODO_COSECHA':np.random.choice(METODO_COSECHA),
'ALMACENAMIENTO_FINCA':np.random.randint(0,1),
'ContEnfQui_Emer_Flor':np.random.randint(0,3),'ContEnfQui_Flor_Cose':np.random.randint(0,1),'ContMalMec_Siem_Emer':np.random.randint(0,1),'ContMalMec_Emer_Flor':np.random.randint(0,1),
'ContMalMec_Flor_Cose':np.random.randint(0,1),'ContMalQui_Antes_Siem':np.random.randint(0,2),'ContMalQui_Siem_Emer':np.random.randint(0,3),'ContMalQui_Emer_Flor':np.random.randint(0,4),
'ContMalQui_Flor_Cose':np.random.randint(0,2),'ContPlaQui_Antes_Siem':np.random.randint(0,1),'ContPlaQui_Siem_Emer':np.random.randint(0,2),'ContPlaQui_Emer_Flor':np.random.randint(0,9),
'ContPlaQui_Flor_Cose':np.random.randint(0,2),'TotN_Antes_Siem':round(np.random.uniform(0,115),2),'TotN_Siem_Emer':round(np.random.uniform(0,82.5),2),'TotN_Emer_Flor':round(np.random.uniform(0,276),2),'TotP_Antes_Siem':np.random.randint(0,24),
'TotP_Siem_Emer':round(np.random.uniform(0,40),2),'TotP_Emer_Flor':round(np.random.uniform(0,47.5),2),'TotK_Antes_Siem':np.random.randint(0,30),'TotK_Siem_Emer':round(np.random.uniform(0,75),2),'TotK_Emer_Flor':round(np.random.uniform(0,180),2),'FerOrg_Emer_Flor':np.random.randint(0,1),
'FerQui_Antes_Siem':np.random.randint(0,3),'FerQui_Siem_Emer':np.random.randint(0,3),'FerQui_Emer_Flor':np.random.randint(0,7)
}'''
...
#print("fitness alpha: ", fitness_alfa)

#print("alpha pos: ", alpha_pos)

#  Mejor solucion
#  La idea es exportar ese DF con esas variables a Optimizar (Archivo.CSV)
# ==================================================================================
#print("mejor solucion: ", alpha_pos[variablesOptimizar])
# Calculamos el rendimiento asociad al cultivo
...
# El rendimeinto esperado el cultivo es
# =============================================================
yield_corn

#  La Ganacia del cultivo es
# ============================================
gan

# Los costos de produccion son:
# ===============================================
costo